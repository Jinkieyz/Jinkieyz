...
## Current work: Hard Copy

My degree project at Konstfack explores what happens when 7843 photographs of my own sculptures are fed into neural networks trained from scratch. The trained models produce new images that I then materialize back into physical glass objects, closing a loop between code and craft. 103 lines of executable code from my GitHub are cast as glass plates. The code does not run in glass. But it is preserved.
...
Glass casting, cast glass glaze (frits, lithium carbonate, kaolin, quartz, borax), blown glass, hot blowmold (gypsum-quartz), copper electroforming, lost-PLA casting, 3D printing.

## Links

- [vetroal.se](https://vetroal.se) - Portfolio
- [vetroal.se/bio](https://vetroal.se/bio/) - Full artist bio
- [@garbitch_nadja](https://instagram.com/garbitch_nadja) - Instagram
